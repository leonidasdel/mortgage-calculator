...
export class HomeComponent {
  ...
  readonly tools: HomeTool[] = [
    ...
    { route: '/holiday-bonus', name: 'Δώρα Εορτών', desc: 'Χριστουγέννων, Πάσχα, επίδομα', icon: '🎁', gradient: 'holiday-bonus-gradient', category: 'Εισόδημα', keywords: 'δώρα' },
    { route: '/severance', name: 'Αποζημίωση Απόλυσης', desc: 'Ν.4808/2021', icon: '📄', gradient: 'severance-gradient', category: 'Εισόδημα', keywords: 'απόλυση αποζημίωση' },
    { route: '/inheritance-gift', name: 'Φόρος Κληρονομιάς & Δωρεάς', desc: 'Κατηγορίες Α/Β/Γ', icon: '🏛️', gradient: 'rental-tax-gradient', category: 'Φόροι', keywords: 'κληρονομιά δωρεά' },
    { route: '/crypto-tax', name: 'Φόρος Κρυπτονομισμάτων', desc: '15% κέρδη κεφαλαίου', icon: '₿', gradient: 'consumer-loan-gradient', category: 'Φόροι', keywords: 'crypto bitcoin' },
    { route: '/interest', name: 'Υπολογισμός Τόκων', desc: 'Καθαρή απόδοση καταθέσεων', icon: '📈', gradient: 'interest-gradient', category: 'Αποταμίευση', keywords: 'τόκοι' },
    { route: '/savings', name: 'Αποταμίευση', desc: 'Σύνθετος τόκος', icon: '🪴', gradient: 'savings-gradient', category: 'Αποταμίευση', keywords: 'αποταμίευση' },
    { route: '/car-cost', name: 'Κόστος Αυτοκινήτου', desc: 'Τέλη κυκλοφορίας 2026', icon: '🚗', gradient: 'rent-vs-buy-gradient', category: 'Άλλα', keywords: 'αυτοκίνητο τέλη' },
    { route: '/rent-vs-buy', name: 'Νοικιάζω ή Αγοράζω;', desc: 'Σύγκριση κόστους', icon: '🏠', gradient: 'rent-vs-buy-gradient', category: 'Ακίνητα', keywords: 'ενοίκιο αγορά' },
    { route: '/rental-tax', name: 'Φόρος Ενοικίου', desc: 'Φόρος εισοδήματος ενοικίων', icon: '🏘️', gradient: 'rental-tax-gradient', category: 'Ακίνητα', keywords: 'ενοίκιο φόρος' },
