...
export function calculateRentVsBuy(params: RentVsBuyParams, timeHorizon: number): RentVsBuyResult {
  ...
  const monthlyPayment = mortgagePmt(loanAmount, mortgageRate, n);
